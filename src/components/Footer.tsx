const Footer = () => {
  return (
    <div className="flex flex-col px-16 py-11 mt-10 w-full" id="contact">
      <div className="flex flex-col-reverse justify-center items-center gap-7 mb-5  ">
        ...
        <div className="flex flex-col ">
          <div className="flex flex-row items-center mt-1 space-x-3">
            ...
            <a href="mailto:mnmalikdev@gmail.com" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
              <svg
                width="30"
                height="30"
                viewBox="0 0 24 24"
            ...
            <a href="https://wa.me/923425500944" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="30"
                height="30"
            ...
            <a href="https://github.com/mnmalikdev" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="30"
                height="30"
