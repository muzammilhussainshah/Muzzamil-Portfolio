...
const Portfolio: FC = () => {
  ...
  return (
    <div className="lg:py-12 lg:mt-12 bg-[#0D1117]">
      <div data-aos="fade-down" className="text-[#FFFFFF] font-bold text-center text-h3 lg:text-h2" id="projects">
        Noteworthy Projects{" "}
      </div>
      <div data-aos="fade-down" className="text-[#E5E5E5] my-10 text-center">
