...
const Project: FC<ProjectProps> = ({
  ...
  return (
    <div
      className="my-5 lg:flex lg:flex-row-reverse lg:my-[50px] lg:justify-around"
      id={id}
    >
      <div className="mb-4 lg:max-w-lg ">
        ...
        <div
          className={` mt-11 flex flex-col gap-y-4 md:gap-y-0 md:flex-row  lg:flex-${
