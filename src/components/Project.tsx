  ...
  return (
    <div className="my-5 lg:flex lg:flex-row-reverse lg:my-[50px] lg:justify-around" id={id}>
      ...
      <div className="lg:max-w-lg md:mx-1 lg:mx-0">
        ...
        <div className="mb-4 px-2 sm:px-0   text-center lg:text-justify text-paraColor md:text-paraGraphMedium lg:text-start lg:tracking-wide lg:w-4/5 xl:w-full">{description}</div>
