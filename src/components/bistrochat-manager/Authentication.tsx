    ...
    <section>
      <div className="maincontainer">
        <div className="flex flex-col gap-y-6 items-center lg:items-start">
          <div className="font-poppins font-bold lg:body1 text-white py-2 w-[10rem] rounded-[1.2rem] bg-[#8c9dc4] text-center">Authentication</div>
      ...
      <div className="my-10 relative">
        <div className="maincontainer lg:flex">
          <div className="lg:w-1/2 flex flex-col gap-y-3 justify-center items-center lg:items-start">
            <div className="font-poppins font-bold lg:body1 text-white text-head py-2 w-[10rem] rounded-lg bg-[#8c9dc4] text-center">Popular Tools</div>
        ...
        <div className="maincontainer flex flex-col-reverse lg:flex-row ">
          ...
          <div className="lg:w-1/2 w-full flex justify-end items-center">
            <div className="lg:w-[90%] w-full flex flex-col gap-y-3 items-center lg:items-start">
              <div className="font-poppins font-bold lg:body1 text-head py-2 w-[10rem] text-white rounded-lg bg-[#8c9dc4] text-center">Popular Tools</div>
