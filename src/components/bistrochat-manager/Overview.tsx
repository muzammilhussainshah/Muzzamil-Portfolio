      ...
      <div className="maincontainer overflow-hidden">
        ...
        <div className="text-[#E5E5E5] font-poppins font-semibold lg:text-li mt-6 leading-8  text-center lg:text-left lg:text-[16px]">
          <p>
            ...
            your reservations and guest information into one easy-to-use system.
          </p>
          <br />
          <p>
            Bistrochat manager also offers useful automation such as reminders,
            deposit management, integration with POS systems, SMS, connecting to
            your emailing system, and more to ensure your guests are delighted.
          </p>
          <br />
          <p>
            And the best part? It&apos;s all available at an affordable flat fee
            with unlimited bookings.
          </p>
        </div>
      </div>
      <div className="flex my-5 justify-center lg:justify-end">
        <img
          src="images/bistrochatManager/Home.png"
