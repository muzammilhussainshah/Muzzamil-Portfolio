    ...
    return (
        <section className="p-8">
            <div className="maincontainer">
                ...
                <div className="h-10 flex gap-x-4  my-10">
                    <article className="font-bold text-bodyTitleBig whitespace-nowrap">Brand Color</article>
                ...
                <div className="md:flex lg:my-4 md:gap-x-3">
                    <div className="md:w-[35%] my-2 w-full h-[25vh] justify-end  p-2 flex flex-col rounded-lg bg-[#4e0d53]">
                        <div className="font-semibold  text-white font-poppins lg:text-h4">American Purple</div>
                ...
                <div className="h-10 flex gap-x-4  my-10">
                    <article className="font-bold text-bodyTitleBig whitespace-nowrap">Typography</article>
                    <div className="h-1/2 border-b-4  border-b-[#4e0d53] w-full" />
                </div>
