    ...
    <section className="p-8">
      <div className="maincontainer">
        <div className="flex flex-col gap-y-6 items-center lg:items-start">
          ...
          <div className="font-poppins font-semibold text-center text-li lg:text-left lg:text-[16px]">Detailed wireframes incorporate the final design elements, ensuring a visually appealing and functional user interface.</div>
        </div>
      ...
      <div className="my-28 relative">
        <div className="maincontainer lg:flex">
          <div className="lg:w-1/2 flex flex-col gap-y-3 justify-center items-center lg:items-start">
            ...
            <div className="font-poppins font-semibold text-center text-li lg:text-left lg:text-[16px]">There are many people available on this app to give you advice on various issues you might be facing, whether it&apos;s family problems, divorce, anxiety, career issues, or anything else bothering you.</div>
          </div>
        ...
        <div className="maincontainer flex flex-col-reverse lg:flex-row ">
          ...
          <div className="lg:w-1/2 w-full flex justify-end items-center">
            <div className="lg:w-[90%] w-full flex flex-col gap-y-3 items-center lg:items-start">
              ...
              <div className="font-poppins font-semibold text-li text-center lg:text-left lg:text-[16px]">At Chat to Potato, we ensure your privacy while scheduling. Your identity remains confidential, providing peace of mind.</div>
            </div>
          </div>
        </div>
      ...
      <div className="maincontainer lg:flex my-28 ">
        <div className="lg:w-1/2 w-full flex relative flex-col gap-y-3 justify-center items-center lg:items-start">
          ...
          <div className="font-poppins font-semibold text-center text-li lg:text-left lg:text-[16px]">Want to talk without revealing your identity? Our anonymous chat lets you do just that. Share freely, get advice, all while staying private. Start chatting now!</div>
        </div>
