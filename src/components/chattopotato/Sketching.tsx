    ...
    <section className="p-8 bg-[#0D1117]">
      <div className="maincontainer">
        <div >
          ...
          <div className="text-[#E5E5E5] font-poppins font-semibold  text-center lg:text-left text-li mt-6 lg:text-[16px]">Initial sketches focus on creating an intuitive interface prioritizing efficient learning and user convenience.</div>
        </div>
