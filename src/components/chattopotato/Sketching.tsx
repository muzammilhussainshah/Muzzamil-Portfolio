    ...
    <section className="p-8">
      <div className="maincontainer">
        <div >
          ...
          <div className="font-poppins font-semibold  text-center lg:text-left text-li mt-6 lg:text-[16px]">Initial sketches focus on creating an intuitive interface prioritizing efficient learning and user convenience.</div>
        </div>
